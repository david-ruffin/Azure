...
New-AzConnectedMachineRunCommand -ResourceGroupName $resourceGroupName -Location "westus" -SourceScript $script -RunCommandName $patchName -MachineName $arcVMName
